...
export const metadata: Metadata = {
  title: "Subscription Program | JPLC",
  description:
    "JPLC Subscription Program — consistent specialty coffee supply with flexible scheduling for hospitality, office, and retail operations.",
};
    ...
    <main className="relative min-h-screen flex items-center justify-center overflow-hidden bg-white">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 text-center py-24">
        ...
        <p className="text-[#475569] text-[16px] leading-[1.82] mb-10 max-w-lg mx-auto">
          Consistent specialty coffee supply with flexible scheduling for
          hospitality, office, and retail operations — launching soon.
        </p>

...
const pillars = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M17.657 18.657A8 8 0 016.343 7.343M12 4v1m6 2l-.707.707M20 12h-1M17 17l-.707-.707M12 19v1M7 17l.707-.707M5 12H4M7 7l.707.707" />
      </svg>
    ),
  },
  {
...
export function EcosystemSection() {
  return (
    <section id="ecosystem" className="relative pt-8 pb-20 lg:pt-10 lg:pb-28 bg-[#F8FAFC] overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-16 lg:mb-20">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage: "linear-gradient(rgba(79,107,255,1) 1px, transparent 1px), linear-gradient(90deg, rgba(79,107,255,1) 1px, transparent 1px)",
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-white/40 text-[10px] tracking-[0.25em] uppercase">Active</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          {pillars.map((pillar) => (
            ...
            >
              ...
              {/* Hover lift shadow */}
              <div className="absolute inset-0 rounded-sm opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none z-10"
                style={{ boxShadow: "0 20px 60px rgba(47,67,183,0.25), 0 0 0 1px rgba(79,107,255,0.2)" }}
              />
              ...
              <div className="absolute bottom-0 left-0 right-0 p-5 z-10 group-hover:opacity-0 group-hover:translate-y-1 transition-all duration-300">
                <h3 className="text-white text-[13px] font-bold leading-snug tracking-tight" style={{ textShadow: "0 1px 8px rgba(0,0,0,0.7)" }}>
                  {pillar.title}
                </h3>
              </div>
              ...
              <div
                ...
                style={{
                  background: "linear-gradient(to top, rgba(15,23,42,0.95) 0%, rgba(15,23,42,0.82) 100%)",

      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-10">
        <div className="grid lg:grid-cols-[1fr_0.9fr] gap-12 xl:gap-20 items-center">
          ...
          <div>
            ...
            >
              JPLC is a bulk coffee supplier and coffee distributor built for
              hotels, restaurants, cafés, and commercial operations that need
              consistent supply — not a different story every delivery.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span className="relative">Request Wholesale Pricing</span>
                <svg
          ...
          >
            <div className="relative rounded-2xl overflow-hidden shadow-2xl shadow-[#2F43B7]/15">
              <img
                src="/coffee_solutions/Wholesale-speciality-coffee-suppliers.jpg"
                alt="Wholesale specialty coffee suppliers"
              ...
              <div className="absolute bottom-5 left-5 right-5">
                ...
                >
                  ...
                  <span className="text-white text-xs font-medium tracking-wide">
                    Scheduled delivery · Active account management · UAE-wide
                    distribution
                  </span>
                </div>
              </div>

...
const faqs = [
  ...
  },
  {
    ...
    a: "Yes. JPLC manages multi-site supply programmes with centralised account management and coordinated delivery across locations. Whether it's two sites or twenty, the supply programme is structured to handle it.",
  },
  {
    q: "How do I set up a wholesale account with JPLC?",
    a: "Contact our supply team through the wholesale inquiry form. We'll assess your requirements, volume, and delivery needs before proposing a supply programme and pricing structure. No commitment required at the inquiry stage.",
  },
];
          ...
          >
            ...
            <div className="relative z-10 px-6 lg:px-14 py-14 lg:py-16">
              ...
              <p className="text-[#374151] text-lg leading-relaxed max-w-2xl mx-auto mb-10">
                Supply consistency, quality control, and a distributor who
                understands what a high-volume operation actually needs —
                that&apos;s what JPLC wholesale accounts get. If the current
                supplier isn&apos;t delivering on all three, it&apos;s worth a
                conversation.
              </p>

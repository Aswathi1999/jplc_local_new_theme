      ...
      <div className="relative z-10 max-w-7xl mx-auto px-5 lg:px-10">
        <div className="grid lg:grid-cols-[1fr_0.9fr] gap-12 xl:gap-20 items-center">
          ...
          <div>
            ...
            >
              From roast profile to retail shelf — JPLC is a full-service white
              label coffee supplier UAE and coffee manufacturing partner for
              brands that are serious about what they&apos;re putting their name
              on.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <span className="relative">Start a Manufacturing Inquiry</span>
                <svg
              ...
              <div className="absolute bottom-5 left-5 right-5">
                ...
                >
                  ...
                  <span className="text-white text-xs font-medium tracking-wide">
                    DMCC-certified production · Full traceability from green
                    bean to shelf
                  </span>
                </div>
              </div>
